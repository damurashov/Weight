...
extern "C" Place *instantiate(void *argument) { return new Land(argument); }
...
void *Land::callalltest(void *argument) {
    ...
    *ret_val = *(int *)argument * 10.0;
    ...
    if (printOutput == true) {
        convert << "callalltest[" << index[0] << "][" << index[1]
                << "] out of [" << size[0] << "][" << size[1] << "]" << arg
                << ", " << *(int *)argument
...
void *Land::exchangetest(void *argument) {
    ...
    if (printOutput == true) {
        convert << "exchangetest[" << index[0] << "][" << index[1]
                << "] out of [" << size[0] << "][" << size[1]
                << "] received ";  //<< *(int *)argument;
        MASS_base::log(convert.str());
    }
...
void *Land::checkInMessage(void *argument) {
    ...
    if (printOutput == true) {
        convert << "checkInMessage[" << index[0] << "][" << index[1]
                << "] out of [" << size[0] << "][" << size[1]
                << "] inMessages.size = " << inMessages.size() << " received ";
