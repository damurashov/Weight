   ...
   public:
    ...
    virtual void *callMethod(int functionId, void *argument) {
        switch (functionId) {
            ...
            case callalltest_:
                return callalltest(argument);
            case exchangetest_:
                return exchangetest(argument);
            case checkInMessage_:
                return checkInMessage(argument);
            case printOutMessage_:
                return printOutMessage(argument);
            case printShadow_:
                return printShadow(argument);
            case addDestinations_:
                return addDestinations(argument);
                return NULL;
        }
    }
