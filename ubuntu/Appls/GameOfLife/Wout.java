...
class Wout {
	...
	// initialize window and graphics:
        gWin = new JFrame( "Conway's Game of Life" );
	...
	Scanner keyboard = new Scanner( file ); // reading from the standard input

        int iSize = 0;
        int ySize = 0;
        while(keyboard.hasNextLine()) {
            double life = keyboard.nextDouble();
            if (life == 1) {
                life = 20;
            }
            z[ySize][iSize] = life;
